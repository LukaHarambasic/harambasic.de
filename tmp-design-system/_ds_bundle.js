/* @ds-bundle: {"format":3,"namespace":"HarambasicConsultingDesignSystem_26b27b","components":[{"name":"Button","sourcePath":"components/actions/Button.jsx"},{"name":"Avatar","sourcePath":"components/data-display/Avatar.jsx"},{"name":"Badge","sourcePath":"components/data-display/Badge.jsx"},{"name":"Tag","sourcePath":"components/data-display/Tag.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"},{"name":"Callout","sourcePath":"components/surfaces/Callout.jsx"},{"name":"Card","sourcePath":"components/surfaces/Card.jsx"}],"sourceHashes":{"components/actions/Button.jsx":"6dcf406ce972","components/data-display/Avatar.jsx":"c8f217d026e7","components/data-display/Badge.jsx":"e475da97303c","components/data-display/Tag.jsx":"98676868793d","components/forms/Input.jsx":"00a2afd6a953","components/surfaces/Callout.jsx":"1d6714d8935b","components/surfaces/Card.jsx":"3e4d278051d8","slides/deck-stage.js":"9436a2deeb46"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.HarambasicConsultingDesignSystem_26b27b = window.HarambasicConsultingDesignSystem_26b27b || {});
...
function Button({
  ...
  const Tag = as;
  const classes = ['hc-btn', `hc-btn--${variant}`, `hc-btn--${size}`, fullWidth ? 'hc-btn--full' : '', className].filter(Boolean).join(' ');
...
function Avatar({
  ...
  const classes = ['hc-avatar', `hc-avatar--${shape}`, ring ? 'hc-avatar--ring' : '', className].filter(Boolean).join(' ');
...
function Input({
  ...
  const classes = ['hc-field', error ? 'hc-field--error' : '', disabled ? 'hc-field--disabled' : '', className].filter(Boolean).join(' ');
...
function Card({
  ...
  const classes = ['hc-card', surfClass, `hc-card--pad-${padding}`, raised ? 'hc-card--raised' : '', interactive ? 'hc-card--interactive' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement(Tag, _extends({
    className: classes
  }, rest), grain && /*#__PURE__*/React.createElement("span", {
    className: "hc-card__grain",
    "aria-hidden": "true"
  }), children);
}
