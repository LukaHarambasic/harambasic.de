export default {
	...
	footerGenerated: (value: string) =>
		`Unieke afbeelding gegenereerd voor <em>${value}</em> door OpenAi - DALL·E 3`,
	footerBy: () =>
		`Ontworpen & ontwikkeld door <a style="color: rgba(1, 3, 15, 0.6);" href="https://harambasic.de">Luka Harambasic</a>`,
