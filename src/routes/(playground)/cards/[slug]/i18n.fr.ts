export default {
  ...
  footerGenerated: (value: string) => `Image unique générée pour <em>${value}</em> par OpenAi - DALL·E 3`,
  footerBy: () => `Conçu & développé par <a style="color: rgba(1, 3, 15, 0.6);" href="https://harambasic.de">Luka Harambasic</a>`,
